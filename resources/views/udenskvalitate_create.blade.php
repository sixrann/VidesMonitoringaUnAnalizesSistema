...
<body>
    ...
    <div class="container mt-4">
        <h2>Pievienot jaunu udens kvalitātes ierakstu</h2>
        <form method="POST" action="/allData/udenskvalitate">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.1" class="form-control" id="Dzelzs" name="Dzelzs" required>
            </div>
            <div class="mb-3">
                <label for="Mangans" class="form-label">Mangāns</label>
                <input type="number" step="0.1" class="form-control" id="Mangans" name="Mangans" required>
            </div>
            <div class="mb-3">
                <label for="Fosfati" class="form-label">Fosfāti</label>
                <input type="number" step="0.1" class="form-control" id="Fosfati" name="Fosfati" required>
            </div>
            <div class="mb-3">
                <label for="Nitrati" class="form-label">Nitrāti</label>
                <input type="number" step="0.1" class="form-control" id="Nitrati" name="Nitrati" required>
            </div>
            <div class="mb-3">
                <label for="Nitriti" class="form-label">Nitriti</label>
                <input type="number" step="0.1" class="form-control" id="Nitriti" name="Nitriti" required>
            </div>
            <div class="mb-3">
